            ...
            <form method="POST" id="settingsForm">
                ...
                <div class="card mb-4">
                    <div class="card-header bg-warning-subtle">
                        <h5 class="mb-0"><i class="fas fa-envelope-open-text me-2 text-warning"></i>Configuration SMTP (envoi d'emails)</h5>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-info py-2 mb-3">
                            <i class="fas fa-info-circle me-2"></i>
                            Ces paramètres permettent à la plateforme d'envoyer des emails (confirmations de demandes, mots de passe agents…).
                        </div>
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <label class="form-label"><i class="fas fa-server me-1"></i>Serveur SMTP</label>
                                <input type="text" class="form-control" name="smtp_host"
                                    placeholder="smtp.gmail.com"
                                    value="<?= htmlspecialchars($settings['smtp_host'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><i class="fas fa-plug me-1"></i>Port SMTP</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><i class="fas fa-user me-1"></i>Utilisateur SMTP</label>
                                <input type="text" class="form-control" name="smtp_user"
                                    placeholder="votre@email.com"
                                    value="<?= htmlspecialchars($settings['smtp_user'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><i class="fas fa-key me-1"></i>Mot de passe SMTP</label>
                                <div class="input-group">
                                    <input type="password" class="form-control" name="smtp_pass" id="smtp_pass"
                                        placeholder="••••••••"
                                        value="<?= htmlspecialchars($settings['smtp_pass'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                    <button class="btn btn-outline-secondary" type="button"
                                            onclick="toggleSmtp()">
                                        <i class="fas fa-eye" id="smtp_eye"></i>
                                    </button>
                                </div>
...
function toggleSmtp() {
    ...
    const i = document.getElementById('smtp_eye');
    if (f.type === 'password') {
        f.type = 'text';
