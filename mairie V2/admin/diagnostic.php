...
foreach ($dirs as $dir => $label) {
    ...
    if (strpos($dir, 'logs') !== false || strpos($dir, 'uploads') !== false) {
        $ok = $writable;
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr class="category-header">
                            <td colspan="5" class="py-2 ps-3">
                                ...
                                $catIcon = isset($catIcons[$t['category']]) ? $catIcons[$t['category']] : 'circle';
                                ?>
                                <i class="fas fa-<?= htmlspecialchars($catIcon) ?> me-2"></i><?= htmlspecialchars($t['category'], ENT_QUOTES, 'UTF-8') ?>
                            </td>
                        </tr>
                        <?php endif; ?>
                        <tr class="test-row">
