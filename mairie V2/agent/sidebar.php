...
<div class="col-md-2 p-0 sidebar" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh;">
    ...
    <nav>
        ...
        <a href="changer_mot_de_passe.php" class="text-white d-block p-3 <?= $current_page == 'changer_mot_de_passe.php' ? 'active' : '' ?>"
           style="text-decoration: none; <?= $current_page == 'changer_mot_de_passe.php' ? 'background: rgba(255,255,255,0.2);' : '' ?>">
            <i class="fas fa-key me-2"></i>Changer mot de passe
        </a>
        <a href="liste_citoyens.php" class="text-white d-block p-3 <?= $current_page == 'liste_citoyens.php' ? 'active' : '' ?>"
           style="text-decoration: none; <?= $current_page == 'liste_citoyens.php' ? 'background: rgba(255,255,255,0.2);' : '' ?>">
            <i class="fas fa-id-card me-2"></i>Liste citoyens
        </a>
