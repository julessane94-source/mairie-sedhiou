...
Route::middleware(['auth', 'role:admin'])
    ...
    Route::get('citoyens', [Admin\UtilisateurController::class, 'citoyens'])->name('citoyens.index');

    Route::patch('utilisateurs/{user}/role', [Admin\UtilisateurController::class, 'changerRole'])
        ->name('utilisateurs.changerRole');

    Route::patch('utilisateurs/{user}/statut', [Admin\UtilisateurController::class, 'changerStatut'])
        ->name('utilisateurs.changerStatut');

    // ============ GESTION DES AGENTS ============
    Route::resource('agents', Admin\AgentController::class);

    Route::post('agents/{user}/assigner-demande', [Admin\AgentController::class, 'assignerDemande'])
        ->name('agents.assigner-demande');

    Route::post('agents/{user}/retirer-demande', [Admin\AgentController::class, 'deasigner'])
        ->name('agents.deasigner');

    Route::patch('agents/{user}/statut', [Admin\AgentController::class, 'changerStatut'])
        ->name('agents.changerStatut');
...
Route::middleware(['auth', 'role:agent'])->prefix('agent')->name('agent.')->group(function () {
    ...
    // Liste des messages
    Route::get('messages', [Agent\MessageController::class, 'index'])->name('messages.index');
});
