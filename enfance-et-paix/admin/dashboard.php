...
// 3. Initialisation des variables pour éviter les erreurs "Undefined variable"
$site_logo = "logo-default.png";
$nb_agents = 0;
$nb_demandes = 0;

// 4. Vérification que la connexion $conn existe avant de faire les requêtes
if (isset($conn) && $conn) {
    ...
    // Récupération des Statistiques avec vérification
...
<div class="sidebar">
    <div class="sidebar-logo">
        ...
        <p style="font-size: 0.8rem; margin-top: 10px; font-weight: 700; letter-spacing: 1px;">ESPACE ADMIN</p>
    </div>
    <nav class="nav-menu">
...
<div class="main-content">
    <header class="header-top">
        <div>
            ...
            <p style="color: #64748b; margin-top: 5px;">Bienvenue, Administrateur.</p>
        </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card" style="border-left-color: var(--accent);">
            ...
            <div class="value" style="font-size: 1.2rem; color: #1e293b;"><?= date('d/m/Y') ?></div>
        </div>
    </div>
    ...
    <div class="container-grid">
        <a href="gestion-agent.php" class="card">
            ...
            <h3>Agents</h3>
            <p>Gérer les comptes et accès</p>
        </a>
        <a href="gestion-pages.php" class="card">
            <i class="fas fa-edit"></i>
            <h3>Pages</h3>
            <p>Modifier le contenu textuel</p>
        </a>
        <a href="gestion-formations.php" class="card">
            <i class="fas fa-book-reader"></i>
            <h3>Formations</h3>
            <p>Programmes et inscriptions</p>
        </a>
