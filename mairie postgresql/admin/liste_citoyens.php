...
try {
    if ($search !== '') {
        ...
        $total  = (int)$pdo->prepare("
            ...
            WHERE c.numero_citoyen ILIKE ?
               OR u.nom ILIKE ?
               OR u.prenom ILIKE ?
               OR u.email ILIKE ?
        ")->execute([$like,$like,$like,$like]) ? $pdo->query("
            SELECT COUNT(*) FROM citoyens c
            JOIN users u ON c.user_id = u.id
            WHERE c.numero_citoyen ILIKE '$like'
               OR u.nom ILIKE '$like'
               OR u.prenom ILIKE '$like'
    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="export.php?type=citoyens" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card border-0 shadow-sm">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            <thead class="table-dark">
                                <tr>
                                    <th><i class="fas fa-fingerprint me-1"></i>N°CIT</th>
                                    <th>Nom complet</th>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($c['date_naissance']): ?>
                                                <i class="fas fa-birthday-cake text-muted me-1"></i>
                                                <?= date('d/m/Y', strtotime($c['date_naissance'])) ?>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php if ($c['email']): ?>
                                                <a href="mailto:<?= e($c['email']) ?>" class="text-decoration-none small">
                                                    <?= e($c['email']) ?>
                                                </a>
                                            <?php else: ?>
                                                <span class="text-muted">—</span>
                                        ...
                                        <td><?= e($c['telephone'] ?? '—') ?></td>
                                        <td>
                                            <span class="small text-muted"><?= e(mb_strimwidth($c['adresse'] ?? '—', 0, 35, '…')) ?></span>
                                        </td>
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    <small class="text-muted">
                        Affichage de <?= min(($page-1)*$perPage+1, $total) ?> à <?= min($page*$perPage, $total) ?> sur <?= $total ?>
                    </small>
                    <nav>
            ...
            <div class="alert alert-info mt-4">
                ...
                — composé de la <strong>date de naissance</strong> (AAAAMMJJ) et du <strong>numéro de registre</strong> (5 chiffres).
            </div>
